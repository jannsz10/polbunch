...
and besides the default, the other alternatives are neither consistent with theory, unbiased or consistent. The default choise of estimator(3) implements 
...
If one of the more restrictive estimators 1-3 are specified, polbunch estimates the corresponding model using nonlinear least squares, based on initial 
